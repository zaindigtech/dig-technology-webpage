...
const LOGOS = [
  { name: 'Aker BP', logo: 'AkerBP_logo.jpg' },
  { name: 'INPEX', logo: 'inpex_logo.png' },
  { name: 'OMV', logo: 'OMV_logo_RGB_Deep-Blue.png' },
  { name: 'Petronas', logo: 'Petronas_logo.png' },
  { name: 'PGS', logo: 'PGS_LOGO_RGB.gif' },
  { name: 'DNO', logo: 'DNO_logo.png' },
  { name: 'Sval Energi', logo: 'Sval_main-logo_blue_RGB.png' },
  { name: 'Vår Energi', logo: 'var-energi-black.png' },
  { name: 'Qeye', logo: 'Qeye.svg' },
  { name: 'OpenMind', logo: 'OpenMind.svg' },
  { name: 'Ragnarock Geo', logo: 'Ragnarock_Geo.png' },
  { name: 'Ross Offshore', logo: 'Ross_Offshore.png' },
  { name: 'Migris', logo: 'Migris.png' },
];
      ...
      <div className="container">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6">
          {LOGOS.map((item, i) => {
            ...
            const imgSrc = `${import.meta.env.BASE_URL}assets/${isSvg ? 'others' : 'images'}/${item.logo}`;
            return (
              <motion.div 
                key={item.name}
                initial={{ opacity: 0, y: 20 }}
